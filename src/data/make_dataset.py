...
def main(input_filepath, output_filepath):
    ...
    args:
        input_filepath: path to the raw data
        output_filepath: path to the processed data
    """
    ...
    # Load the data
    tr0 = np.load(input_filepath + '/train_0.npz')
    tr1 = np.load(input_filepath + '/train_1.npz')
    tr2 = np.load(input_filepath + '/train_2.npz')
    tr3 = np.load(input_filepath + '/train_3.npz')
    tr4 = np.load(input_filepath + '/train_4.npz')
